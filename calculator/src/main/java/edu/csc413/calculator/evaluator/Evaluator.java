...
public class Evaluator {
  ...
  public void procStack(Operator operator) {

  }


  public int eval(String expression) {
    //this is going to be the eval() method needed to take in a single string parameter,
    //Parses and evaluates the expression and returns the result
    //
    ...
    public int evaluateExpression (String expression ) throws InvalidTokenException {
      ...
      while (this.expressionTokenizer.hasMoreTokens()) {
        ...
        if (!(expressionToken = this.expressionTokenizer.nextToken()).equals(" ")) {
          ...
          if (Operand.check(expressionToken) == true) {
            ...
            Operator newOperator.getOperator(expressionToken);
      ...
      //We will have an operand object here, it will be the final operand in the stack.

      Operand finalTotal = operandStack.pop();
